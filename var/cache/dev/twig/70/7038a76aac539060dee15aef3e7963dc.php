...
class __TwigTemplate_dc6ff20d6c2e74ea3caa42e0a481e563 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 7
        echo "\t<div class=\"flex h-screen bg-[#e9e9e9]\">
...
\t\t\t\t\t<a href=\"";
            ...
            echo "\" class=\"p-link-colored\">logout</a>
\t\t\t\t</div>
\t\t\t";
        }
        // line 44
...
{% block body %}
\t<div class=\"flex h-screen bg-[#e9e9e9]\">
\t\t<form method=\"post\" class=\"m-auto bg-white rounded drop-shadow-md p-[60px] min-w-[400px] flex flex-col\">
...
\t\t\t\t\t<a href=\"{{ path('app_logout') }}\" class=\"p-link-colored\">logout</a>
\t\t\t\t</div>
\t\t\t{% endif %}
\t\t</form>
\t</div>
